  ...
  return (
    <div className='min-h-screen bg-white border-r'>
      {aToken && <ul className='text-[#515151] mt-5'>
        ...
        <NavLink to={'/room-management'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`}>
          <img className='min-w-5' src={assets.appointment_icon} alt='' style={{ filter: 'hue-rotate(45deg)' }} />
          <p className='hidden md:block'>Room Management</p>
        </NavLink>
        <NavLink to={'/billing-management'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`}>
          <img className='min-w-5 font-bold text-lg' src={assets.people_icon} alt='' style={{ filter: 'hue-rotate(180deg)' }} />
        ...
        <NavLink to={'/analytics'} className={({ isActive }) => `flex items-center gap-3 py-3.5 px-3 md:px-9 md:min-w-72 cursor-pointer ${isActive ? 'bg-[#F2F3FF] border-r-4 border-primary' : ''}`}>
          <img className='min-w-5' src={assets.home_icon} alt='' style={{ filter: 'hue-rotate(270deg)' }} />
